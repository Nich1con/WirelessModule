...
MicroDS18B20 <DS_PIN1, sensor1_address> sensor1; // Создаем два датчика с адресацией на одной линии
MicroDS18B20 <DS_PIN1, sensor2_address> sensor2;


/*
   Пример создания датчика без адресации (один датчик на линии)
*/
MicroDS18B20 <DS_PIN2> sensor3; // Создаем еще датчик на отдельной линии без адресации
